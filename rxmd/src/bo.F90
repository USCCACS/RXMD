...
!$omp parallel do default(shared),private(c1,c2,c3,n,i,i1,j,j1,ity,jty,inxn,exp1,exp2,exp12, &
!$omp fn1,fn2,fn3,fn4,fn5,fn23,fn45,fn145,fn1145,u1ij,u1ji,u1ij_inv2,u1ji_inv2,Cf1Aij,Cf1Bij, &
!$omp exp_delt22,Cf1ij,Cf1ji,pboc34,BOpij_2,u45ij,u45ji,exph_45ij,exph_45ji,Cf45ij,Cf45ji, &
!$omp fn45_inv,Cf1ij_div1,Cf1ji_div1,BOp0,BOpsqr,exppboc1i,exppboc2i,exppboc1j,exppboc2j)
do i=1,copyptr(6)
