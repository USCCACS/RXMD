...
!  if(icheck(0)) call checker(i, 0, 0, 0, PEunder, f(1:3,i) )
enddo ! i-loop
...
!               if(icheck(0)) call checker(i, j, k, 0, PEpen, f(1:3,j) )
...
!                  if(icheck(0)) call checker(i, j, 0, 0, PEclmb, f(1:3,i) )
...
!          if(icheck(0)) call checker(i, j, 0, 0, PEbo, f(1:3,i) )
