# Modified by @TaufeqRazakh on Oct-20-2023
# Added `IntelSYCL::SYCL_RUNTIME`
#
...
# Take libintel-ext-pt-* from IPEX 
if(IPEX_FOUND)
  # Find Library directory
  find_file(SYCL_RUNTIME_LIBRARY_DIR
    NAMES
      lib lib64
    HINTS
      ${IPEX_INSTALL_PREFIX}
...
add_library(IntelSYCL::SYCL_RUNTIME INTERFACE IMPORTED)
set_property(TARGET IntelSYCL::SYCL_RUNTIME PROPERTY
  INTERFACE_LINK_DIRECTORIES ${SYCL_RUNTIME_LIBRARY_DIR})
